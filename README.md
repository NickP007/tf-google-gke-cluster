...
config_host - The hostname of the Kubernetes API.
config_token - Token of your service account.
config_ca - PEM-encoded root certificates bundle for TLS authentication.
name - The name of the cluster.

## Requirements
This module requires Terraform 0.12 or later, and the following provider:

hashicorp/google 4.67.0
